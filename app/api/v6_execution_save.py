...
def execution_save(
    ...
    try:
        ...
        saved = db.execute(text("""
            INSERT INTO mcp4.execution_log
            (
                trade_date,
                version,
                capital,
        ...
        """), {
            ...
            "top_stock_code": top_pick["stock_code"],
            "top_stock_name": top_pick["stock_name"],
            ...
            "raw_portfolio_loss_percent": raw_portfolio_loss_percent,
            "reduce_ratio": round(reduce_ratio, 4),
            "orders_json": str(safe_orders).replace("'", '"'),
            "comment": comment
        }).fetchone()
